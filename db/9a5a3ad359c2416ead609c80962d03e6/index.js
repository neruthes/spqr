	...
	var txt = function (st) {
		...
		return `html, body, h1, h2, h3, h4, h5, h6, p, ul, ol, li, aside, textarea, input, button, blockquote, form, table, tbody, tl, td, tr, article, section, div, a, figure, header, footer, q, cite, em, strong, address, time, dfn, caption
		{
			${[
				...
				'font-family: "JetBrains Mono", "Source Code Pro", "Roboto Mono", "Inconsolata", "Courier", "Menlo", "Consolas", monospace, "PingFang SC", "Noto Sans CJK SC", "Source Han Sans CN", "Hiragino Sans GB", "Hiragino Sans", "Heiti SC", "Microsoft YaHei" !important;'
			][st]}
		}
		html, body {
